<div class="shop-icons-wrapper shop-icons-wrapper-mobile">
    <div class="shop-icons-wrapper-mobile__left">
        ...
        <div class="search-icon-wrapper">
            <div id="search-icon" class="wrapper-flex-column">
                ...
                <path fill="#ccc" d="M55.146,51.887L41.588,37.786c3.486-4.144,5.396-9.358,5.396-14.786c0-12.682-10.318-23-23-23s-23,10.318-23,23

...
<div id="page" class="site">
 ...
 ?>
	...
	<header id="masthead" class="site-header <?php if ($isActive == 1):
 	echo "promo-navigation";
 endif; ?>">

		<?php if ($isActive == 1):
  	echo '<a class="top-promo" href=' .
  		$toppromo["top_promo_link"] .
  		'><div class="top-promo-item promo-item-1">' .
  		$toppromo["top_promo_text_1"] .
  		'</div> <div class="top-promo-item promo-item-2">  ' .
  		$toppromo["top_promo_text_2"] .
  		"</div></a>";
  endif; ?>

		<nav id="site-navigation" class="main-navigation">

			<?php get_template_part("template-parts/header-top-mobile"); ?>

			<?php get_template_part("template-parts/header-top-desktop"); ?>
		...
		<div class="mobile-menu">
			...
			<div class="mobile-menu__top">
				...
				<div class="quick-contact__wrapper">
					...
					<?php $phone_number_2 = get_field(
						"phone_number_2",
						get_page_by_title("O nas")
					); ?>
					...
					<div class="social-media">
						...
						<div class="quick-contact__wrapper">
							...
							<?php $phone_number_2 = get_field(
								...
								<a class="fixed-icons__icon" href="tel:<?php echo $phone_number_2; ?>"></a>
						...
						<a href="<?php echo $facebook_link; ?>" target="_blank" class="fixed-icons__icon">
							<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="30" viewBox="0 0 24 24" width="36"><rect fill="none" height="42" width="36"/><path fill="#099bde" d="M22,12c0-5.52-4.48-10-10-10S2,6.48,2,12c0,4.84,3.44,8.87,8,9.8V15H8v-3h2V9.5C10,7.57,11.57,6,13.5,6H16v3h-2 c-0.55,0-1,0.45-1,1v2h3v3h-3v6.95C18.05,21.45,22,17.19,22,12z"/></svg>
						</a>
